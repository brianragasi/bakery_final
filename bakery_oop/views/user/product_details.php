                            ...
                            <?php if ($product['quantity'] > 0): ?>
                                <?php if (isset($_SESSION['user_id'])): ?>
                                    <div class="flex items-center space-x-4"> 
                                        ...
                                        <input type="number" name="quantity" id="quantity-<?= $product['id'] ?>" value="1" min="1" class="w-16 px-2 py-1 border rounded focus:outline-none focus:ring-2 focus:ring-primary">
